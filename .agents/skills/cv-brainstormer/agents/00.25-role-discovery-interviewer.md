...
Fit criteria definitions:
- High: >70% evidence alignment
- Moderate: 40-70% evidence alignment
- Low: <40% evidence alignment

| Role Family | Fit | Estimated Level | Evidence | Risk / Missing Proof |
|-------------|-----|-----------------|----------|----------------------|
| [Primary Domain Track] | | | | |
| [Secondary Domain Track] | | | | |
| [Adjacent / Transition Track] | | | | |

#### Example (Tech/Support Candidate)
| Role Family | Fit | Estimated Level | Evidence | Risk / Missing Proof |
|-------------|-----|-----------------|----------|----------------------|
| CV-inferred primary family | High | L2 Support | Daily ticketing, direct client interaction | Lacks root cause analysis |
| Application Support / Production Support | Moderate | L1/L2 | Forward tickets, escalate to devs | No DB/log access |
| Technical Support Engineer | Low | Entry | Uses ticketing tool | Needs infrastructure exposure |
| SQL Support / Data Support Analyst | Low | N/A | Basic query skills | No production data updates |
| Manual QA / Application Support QA | Moderate | Junior QA | Runs test scripts | Doesn't write test cases |
...
## When NOT to Run
- Skip if candidate has already been through role discovery in a prior run and nothing has changed.

## Dependencies
- **Receives from:** Agent 00
- **Feeds into:** Agent 00.5, Agent 07, Agent 10

## Quality Checklist
Before finalizing output, verify:
- [ ] Classification relies on CV evidence rather than assuming title is correct
- [ ] Asked relevant domain questions before making a final determination
- [ ] Fit criteria (High/Moderate/Low) are applied correctly according to evidence percentage
- [ ] Output table uses dynamic domains matched to the candidate rather than hardcoded IT rows

## Changelog
- v1.1 (2026-09-09): Fixed title typography, generalized output template, added fit criteria, added When NOT to Run section
